...
### Требования (валидные данные) к заполнению формы заявки на обучение профессии "Тестировщик ПО":
...
_Например: +7 (900) 777-77-77_

#### Поле ввода электронной почты:
* Имя почтового ящика и доменное имя, разделенные символом "@"

_Например: test@mail.com_
...
#### 6. Незаполненное имя:
1. Ввести валидное значение в поле ввода номера телефона
2. Ввести валидное значение в поле "Электронная почта"
3. Нажать кнопку "Записаться" в форме "Запишитесь на курс"

*Ожидаемый результат:* Данные не отправлены. Под полем "Имя" сообщение красным цветом "Обязательное поле"

#### 7. Незаполненный номер телефона:
1. Ввести валидное значение в поле "Имя"
2. Ввести валидное значение в поле "Электронная почта"
3. Нажать кнопку "Записаться" в форме "Запишитесь на курс"

*Ожидаемый результат:* Данные не отправлены. Под полем номера телефона сообщение красным цветом "Обязательное поле"

#### 8. Незаполненная электронная почта:
1. Ввести валидное значение в поле "Имя"
2. Ввести валидное значение в поле ввода номера телефона
3. Нажать кнопку "Записаться" в форме "Запишитесь на курс"

*Ожидаемый результат:* Данные не отправлены. Под полем "Электронная почта" сообщение красным цветом "Обязательное поле"
